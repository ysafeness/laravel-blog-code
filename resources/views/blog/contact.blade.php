    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-10 mx-auto">
                ...
                <p>想与我联系？填写下面的表单给我发消息，我会尽快给你回复！</p>

                <form action="/contact" name="sentMessage" method="POST" id="contactForm" novalidate>
                    ...
                    <div class="control-group">
                        <div class="form-group floating-label-form-group controls">
                            <label>手机</label>
                            <input type="tel" name="phone" class="form-control" placeholder="填写你的手机号码" id="phone" value="{{old('phone')}}" required>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        <div class="form-group floating-label-form-group controls">
                            <label>消息</label>
                            <textarea name="message" class="form-control" placeholder="填写你想发送的消息" id="message" rows="5" value="{{old('message')}}" required></textarea>
                        </div>
                    </div>
                    <br>
