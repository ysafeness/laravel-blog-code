                                ...
                                <div class="col-md-8">
                                    <div class="form-group row">
                                        <div class="col-md-10 offest-md-2">
                                            <button class="btn btn-primary" name="action" type="submit" value="continue"> 
                                                <i class="fa fa-floppy-o"></i> 保存 - 继续
                                            </button>
                                            <button class="btn btn-success" type="submit" name="action" value="finished">
                                                <i class="fa fa-floppy-o"></i> 保存 - 完成
                                            </button>
                                            <button class="btn btn-danger" type="button" data-bs-toggle="modal" data-bs-target="#modal-delete">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p class="lead">
                            <i class="fa fa-question-circle fa-lg"></i> 确定要删除这篇文章？
                        </p>
                    </div>
