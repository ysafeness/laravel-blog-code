            ...
            <form action="/admin/upload/folder" class="form-horizontal" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="new_folder_name" class="col-sm-3 col-form-label">目录名</label>
                        <div class="col-sm-8">
                            <input type="text" id="new_folder_name" name="new_folder" class="form-control" placeholder="新建的目录名称">
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="/admin/upload/file" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="file" class="col-sm-3 col-form-label">文件</label>
                        <div class="col-sm-8">
                            <input type="file" id="file" name="file" class="form-control" placeholder="上传文件">
                        </div>
                    </div>
                    <div class="form-group row">
