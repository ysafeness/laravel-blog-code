...
class PostController extends Controller
{
    ...
    public function create()
    {
        ...
        $this->fieldList['publish_date'] = $when->format('Y-m-d');
        $this->fieldList['publish_time'] = $when->format('g:i A');

        foreach ($this->fieldList as $fieldName => $fieldValue) 
        {
            $this->fieldList[$fieldName] = old($fieldName,$fieldValue);
        }
        $data = array_merge($this->fieldList,[
